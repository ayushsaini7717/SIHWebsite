  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
        <a
          href="#register"
          className="px-8 py-3 bg-orange-500 hover:bg-orange-600 rounded-xl text-white font-semibold shadow-lg transition-colors text-center"
        >
          Register Now
        </a>
        <button
          ...
          className="px-6 py-3 border-none rounded-xl bg-green-500 cursor-pointer shadow-lg transition-colors hover:bg-green-600 text-white font-semibold"
        >
