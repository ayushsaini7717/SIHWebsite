...
const HeroSection = () => {
  ...
  return (
    <section
      id="home"
      className="h-screen flex flex-col items-center justify-center text-center bg-gradient-to-r from-blue-900 via-slate-900 to-green-800 px-4"
    >
      <img
        src="/btkitLOGO.png"
        alt="BTKIT Logo"
      ...
      <p className="text-base md:text-xl mb-6 text-green-400 font-semibold italic">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
        ...
        <button
          ...
          className="px-8 py-3 border border-green-400 rounded-xl text-white font-semibold hover:bg-white/10 transition-all"
        >
          Notices & Information
        </button>
      </div>
      ...
      <p className="text-s text-gray-400 mt-6">
        Organized on <span className="text-green-400">4th November 2025</span> |
        Theme: <span className="text-blue-400">Vikshit Uttarakhand</span>
      </p>
    </section>
  );
};
